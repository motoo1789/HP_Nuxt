            ...
            projects: [
                {
                    ...
                    img: require(`@/assets/img/HP用WinRate写真.png`),
                    movie: require(`@/assets/movie/HP用WinRate.mp4`),
                },
                {
                    projectNum: 2,
                    title: "UMLDS",
                    ...
                    img: require(`@/assets/img/HP用UMLDS.png`),
                    movie: require(`@/assets/movie/HP用UMLDS.mp4`),
                },
            ],
        }
    },
